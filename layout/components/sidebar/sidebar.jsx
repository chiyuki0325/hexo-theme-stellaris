...
const Sidebar = (props) => {
  ...
  if (page.sidebar === undefined) {
    if (page.layout === 'post' && page.content) {
      ...
      is_tag() ||
      is_archive() ||
      ['categories', 'tags', 'archives'].includes(page.layout)
    ) {
          ...
          <widget className='widget-wrapper logo-wrap wiki' key='wiki'>
            <div className='widget-body'>
              ...
              {(() => {
                ...
                let url = proj.homepage?.path || proj.homepage || undefined
                let sub = proj.subtitle
                return (
                  <HeaderTitle {...props} main={main} url={url} sub={sub} />
                )
              })()}
            </div>
          </widget>
          ...
          <div className='social-wrap'>
            {Object.keys(theme.footer.social).map((id) => {
              ...
              if (id == 'darkmode' && theme.style.darkmode == 'auto-switch') {
                return (
                  <div
                    className='darkmode-switch-container social on-click-event'
              ...
              if (item.icon && (item.url || item.onclick)) {
                ...
                return (
                  <a
                    className='social on-click-event'
                    title={item.title || ''}
  ...
  return (
    <Fragment>
      {(page.header === undefined ||
        page.header === 'left' ||
        page.header === 'auto') && <SidebarHeader where='sidebar' {...props} />}
      <Widgets {...props} />
      <Footer {...props} />
    </Fragment>
  )
