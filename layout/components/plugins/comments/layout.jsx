const Comments = (props) => {
  ...
  if (loadComment && page.layout === 'wiki' && page.wiki && proj != null) {
    if (proj.comment_title !== undefined && page.comment_title === undefined) {
      if (
        ['utterances', 'beaudar', 'giscus'].includes(theme.comments.service)
      ) {
